...
class SceneComposer {
    constructor(projectGraph) {
        if (!projectGraph) throw new Error("SceneComposer requires a ProjectGraph instance");
        this.projectGraph = projectGraph;

        // Event callbacks
        this.onSceneFileGenerated = null;
        this.onScriptFileGenerated = null;
    }
